...
class TreeMarkovNetwork(MarkovNetwork):
    ...
    def factorToVar(self, node, var):
        ...
        :param node: A MarkovNetFactor node. The method will calculate the
                     message that this node passes to the variable in the var
                     argument
        :param var:  Instance of RandVar. The calculated message will pass to
                     the node representing this variable
        """
    ...
    def varToFactor(self, node, factor):
        ...
        :param node:   A MarkovNetVar node. The method will calculate the
                       ...
                       factor argument
        :param factor: Instance of Factor. The calculated message will pass to
                       the node representing this factor
        """
